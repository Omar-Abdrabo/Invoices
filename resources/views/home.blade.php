                        ...
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    {{ number_format(App\Models\invoices::sum('amount_collection'), 2) }}
                                </h4>
                        ...
                        <div class="d-flex">
                            <div class="">
                                <h3 class="tx-20 font-weight-bold mb-1 text-white">
                                    {{ number_format(App\Models\invoices::where('value_status', 2)->sum('amount_collection'), 2) }}
                                </h3>
                                    ...
                                    @php
                                        ...
                                        if ($count_invoices2 == 0) {
                                            ...
                                            echo $count_invoices2 =
                                                number_format(($count_invoices2 / $count_all) * 100, 2) . ' %';
                                        }
                                    @endphp
                                </span>
                            </span>
                ...
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    {{ number_format(App\Models\invoices::where('value_status', 1)->sum('amount_collection'), 2) }}
                                </h4>
                                <p class="mb-0 tx-12 text-white op-7">
                                    ...
                                    @php
                                        ...
                                        if ($count_invoices1 == 0) {
                                            ...
                                            echo $count_invoices1 =
                                                number_format(($count_invoices1 / $count_all) * 100, 2) . ' %';
                                        }
                                    @endphp
                                </span>
                            </span>
                ...
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    {{ number_format(App\Models\invoices::where('value_status', 3)->sum('amount_collection'), 2) }}
                                </h4>
                                <p class="mb-0 tx-12 text-white op-7">
