        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between"><a href="invoices/create"
                            ...
                            <tbody>
                                ...
                                @foreach ($invos as $invo)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $invo->product }}</td>
                                        <td><a
                                                href="{{ url('InvoicesDetails') }}/{{ $invo->id }}">{{ $invo->allSection->section_name }}</a>
                                        </td>
                                        <td>{{ $invo->discount }}</td>
                                        <td>{{ $invo->rate_vat }}</td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    <a class="dropdown-item"
                                                        href=" {{ url('edit_invoice') }}/{{ $invo->id }}">تعديل
                                                        الفاتورة
                                                    </a>
                                                    <a class="dropdown-item" href="#"
                                                        data-invoice_id="{{ $invo->id }}" data-toggle="modal"
