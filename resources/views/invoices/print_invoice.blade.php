                        ...
                        <div class="table-responsive mg-t-40">
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td class="tx-12">{{ $invo->product }}</td>
                                        <td class="tx-center">{{ number_format($invo->amount_collection, 2) }}</td>
                                        <td class="tx-right">{{ number_format($invo->amount_commission, 2) }}</td>
                                        @php
                                            $total = $invo->amount_collection + $invo->amount_commission;
                                        @endphp
                                        <td class="tx-right">
                                    ...
                                    <tr>
                                        <td class="tx-right">نسبة الضريبة ({{ $invo->rate_vat }})</td>
                                        <td class="tx-right" colspan="2">287.50</td>
                                    </tr>
                                    <tr>
                                        <td class="tx-right">قيمة الخصم</td>
                                        <td class="tx-right" colspan="2"> {{ number_format($invo->discount, 2) }}</td>
                                    </tr>
                                    <tr>
                                        <td class="tx-right tx-uppercase tx-bold tx-inverse">الاجمالي شامل الضريبة</td>
                                        <td class="tx-right" colspan="2">
                                            <h4 class="tx-primary tx-bold">{{ number_format($invo->total, 2) }}</h4>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
